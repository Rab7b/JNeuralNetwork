...
public class Xor {
    ...
    public void testModel() throws Exception {
        ...
        Model network = new Model(new int[] { 2, 4, 2 }, 0.1);
        ...
        System.out.println("Training started with MultiTask...");

        for (int epoch = 0; epoch < 10000; epoch++) {

            MultiTask currentTask = new MultiTask();

            for (int i = 0; i < inputs.length; i++) {
                final int index = i;
                currentTask.doIt((progress) -> {
